/* Restarant 생성자 함수 */
function Restarant(resName, resAddress, resMenu){
    
    //생성자 함수 안에서 this == 객체 잦체
    //속성(변수, 필드)
...
//샘플 식당 데이터 추가
resList.push(new Restarant("김밥천국", "김밥, 라면", "서울시 중구 어딘가"));
resList.push(new Restarant("왕가탕후루", "샤인머스켓, 딸기, 통귤", "서울시 서대문구"));
...
addBtn.addEventListener("click", () => {
    ...
    resList.push(new Restarant(resName.value,resAddress.value,resMenu.value));

    //이전 input의 작성된 내용을 삭제
    resName.value="";
    resAddress.value="";
    resMenu.value="";
