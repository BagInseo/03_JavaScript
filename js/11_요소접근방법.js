...
function Reset(){
   ...
   function nameTest(){
    ...
    for(let i=0; i<hobbyList.length; i++){
        ...
        //체크 여부를 검사해서체크가 되어있다면 
        //체크된 요소의 값을 str 변수에 누적 + count 값을 증가
...
/*     const div1= document.querySelector('[target-div="css-div"] > div:first-child');
    ...
    //첫 번째 자식div 선택 방법2
    //-> querySelecto()의 첫 번째 요소만 선택한다는 특징 활용
...
function readValue(){
    ...
    const input=document.querySelector("#user-input"); //채팅 내용 input
